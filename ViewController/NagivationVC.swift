...
class NagivationVC: BaseViewController , CLLocationManagerDelegate{
    
    let sails = Sails()
    let sailsMapView = SailsLocationMapView(frame: UIScreen.main.bounds)
    let locationManager = CLLocationManager()
    var clickTimes = 0
    var startLocation :LocationRegion
    ...
    override func viewDidLoad() {
        ...
        /*
        sailsMapView.setOnRegionClick(([Any]?)-> Void!{}){
        }
 */
        /*
         :^(NSArray *locationRegions) {
